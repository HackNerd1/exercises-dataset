...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-md gap-3 bg-background dark:bg-white/5 p-1 text-foreground",
      className
    )}
    {...props}
  />
